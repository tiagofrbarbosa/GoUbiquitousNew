 ...
 */
public class UbiWatchFace extends CanvasWatchFaceService {
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<UbiWatchFace.Engine> mWeakReference;

        public EngineHandler(UbiWatchFace.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            UbiWatchFace.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(UbiWatchFace.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_VARIABLE)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .setAcceptsTapEvents(true)
                    .build());
            Resources resources = UbiWatchFace.this.getResources();
        ...
        private void registerReceiver() {
            ...
            UbiWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            UbiWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float weatherSize = resources.getDimension(R.dimen.digital_weather_size);
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            String date = String.format("%02d/%02d/%02d", mCalendar.get(Calendar.DAY_OF_MONTH),
